export const i18n = {
  ...
  breadcrumbLevel3: 'Update product version',
  infoHeader: 'Update version',
  infoDescription: 'In this screen you can update an existing product version.',
  productDescLabel: 'Description',
  productDescPlaceholder: 'Enter product description',
  updateSuccessMessageHeader: 'Success!',
  updateSuccessMessageContent: 'Product version updated successfully.',
  updateFailMessageHeader: 'Error while updating product version!',
  cancelButtonText: 'Cancel',
  createButtonText: 'Update version',
