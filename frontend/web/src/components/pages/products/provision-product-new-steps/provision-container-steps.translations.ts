...
export const i18nContainerSteps = {
  ...
  formFieldRegionDescriptionLatencies:
    'Location where the container will be hosted. The recommended option, offering the best performance, will be automatically selected during each latency check. You may override this selection if needed.',
  ...
  formFieldStageDescription:
    'Stage at which the container is available from DEV, QA and PROD.',
