...
export const i18nVirtualTargetSteps = {
  ...
  formFieldRegionDescriptionLatencies:
    'Location where the virtual target will be hosted. The recommended option, offering the best performance, will be automatically selected during each latency check. You may override this selection if needed.',
  ...
  formFieldStageDescription:
    'Stage at which the virtual target is available from DEV, QA and PROD.',
