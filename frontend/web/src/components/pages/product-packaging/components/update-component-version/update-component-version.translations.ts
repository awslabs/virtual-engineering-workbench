export const i18n = {
  ...
  breadcrumbLevel3: 'Update component version',
  header: 'Update version',
  headerDescription: 'Update the component version by changing the YAML definition',
  cancelButtonText: 'Cancel',
  updateButtonText: 'Update version',
  updateSuccessMessageHeader: 'Version update started successfully',
  createSuccessMessageContent: 'Version update may take a few minutes. Refer to table below for status.',
  updateFailMessageHeader: 'Failed to update version',
  warningFetchVersionYamlDefinition: 'YAML definition could not be fetched',
