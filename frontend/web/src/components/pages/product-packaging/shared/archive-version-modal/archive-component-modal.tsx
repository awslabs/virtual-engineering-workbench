...
import { i18n } from './archive-component.translations';
...
export const ArchiveComponentModal: FC<Props> = ({
  componentName,
  isOpen,
  onClose,
  onConfirm,
  ...
  return (
    <Modal
      ...
      data-test='archive-component-modal'
    >
      <p>{i18n.modalDescriptionTop} <strong>{componentName}</strong>.</p>
