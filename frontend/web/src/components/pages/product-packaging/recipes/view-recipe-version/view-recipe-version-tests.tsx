...
import { useViewRecipeVersionTests } from './view-recipe-version-tests.logic';
import { packagingAPI } from '../../../../../services';
import { TestExecutionStatus } from '../../shared/test-execution-status';

export const ViewRecipeVersionTests = ({
  recipeId,
  versionId,
}: {
  recipeId: string,
  ...
  const columnDefinitions: TableProps.ColumnDefinition<RecipeVersionTestExecutionSummary>[] = [
    {
      id: 'testExecutionId',
  ...
  return <Table
    ...
    data-test="recipe-version-test-executions"
  />;
};