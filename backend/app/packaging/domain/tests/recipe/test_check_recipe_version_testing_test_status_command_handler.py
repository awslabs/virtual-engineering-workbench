...
from app.packaging.domain.command_handlers.recipe import check_recipe_version_testing_test_status_command_handler
from app.packaging.domain.model.recipe import recipe_version_test_execution


@pytest.fixture
def get_test_recipe_version_test_execution_with_specific_instance_id_and_test_command():
    def _get_test_recipe_version_test_execution_with_specific_instance_id_and_test_command(
        instance_id: str,
        test_command_id: str,
    ...
    return _get_test_recipe_version_test_execution_with_specific_instance_id_and_test_command
...
def test_handle_should_check_recipe_version_testing_test_status(
    check_recipe_version_testing_test_status_command_mock,
    get_test_recipe_version_test_execution_with_specific_instance_id_and_test_command,
    ...
    recipe_version_test_execution_query_service_mock.get_recipe_version_test_execution.return_value = (
        get_test_recipe_version_test_execution_with_specific_instance_id_and_test_command(
            ...
            test_command_status=command_execution[command_id].get("status"),
    ...
    # ACT
    testing_environment_setup_command_status = check_recipe_version_testing_test_status_command_handler.handle(
        command=check_recipe_version_testing_test_status_command_mock,
    ...
    update_attributes = {"testCommandStatus": command_execution[command_id].get("status")}
