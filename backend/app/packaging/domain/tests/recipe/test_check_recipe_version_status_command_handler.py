...
from app.packaging.domain.command_handlers.recipe import check_recipe_version_status_command_handler
...
def test_handle_should_return_validated_when_recipe_version_is_validated():
    # ARRANGE
    # Mock dependencies
    ...
    # ACT
    result = check_recipe_version_status_command_handler.handle(
        command=command,
        recipe_version_query_service=recipe_version_query_service_mock,
    )

    # ASSERT
    assertpy.assert_that(result["recipeVersionStatus"]).is_equal_to(recipe_version.RecipeVersionStatus.Validated.value)
...
def test_handle_should_return_in_progress_when_recipe_version_is_creating():
    # ARRANGE
    # Mock dependencies
    recipe_version_query_service_mock = mock.Mock()
    ...
    # ASSERT
    assertpy.assert_that(result["recipeVersionStatus"]).is_equal_to(recipe_version.RecipeVersionStatus.Testing.value)
