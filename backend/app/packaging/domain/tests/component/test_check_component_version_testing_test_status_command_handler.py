...
@pytest.fixture()
def check_component_version_testing_test_status_command_mock(
    ...
    return check_component_version_testing_test_status_command.CheckComponentVersionTestingTestStatusCommand(
...
@pytest.fixture
def get_test_component_version_test_execution_with_specific_instance_id_and_test_command(
    get_test_component_version_id, get_test_test_execution_id
):
    def _get_test_component_version_test_execution_with_specific_instance_id_and_test_command(
        instance_id: str,
        test_command_id: str,
    ...
    return _get_test_component_version_test_execution_with_specific_instance_id_and_test_command


@pytest.mark.parametrize(
    "instance_ids, command_executions, desired_aggregate_command_status, desired_test_status",
    (
        (
            ["i-01234567890abcdef"],
            {
            ...
            component_version_test_execution.ComponentVersionTestExecutionStatus.Success,
        ),
        (
            ["i-01234567890abcdef"],
            {
        ...
        (
            ...
            component_version_test_execution.ComponentVersionTestExecutionStatus.Running,
        ),
        (
            ["i-01234567890abcdef", "i-01234567890ghijkl"],
            {
...
def test_handle_should_check_component_version_testing_test_status(
    check_component_version_testing_test_status_command_mock,
    get_test_component_version_test_execution_with_specific_instance_id_and_test_command,
    ...
    component_version_test_execution_query_service_mock.get_component_version_test_executions_by_test_execution_id.return_value = [
        get_test_component_version_test_execution_with_specific_instance_id_and_test_command(
            ...
            test_command_status=command_executions[command_id].get("previous_command_status"),
    ...
    # ACT
    testing_environment_setup_command_status = check_component_version_testing_test_status_command_handler.handle(
        command=check_component_version_testing_test_status_command_mock,
    ...
    for command_id, instance_id in zip(command_executions.keys(), instance_ids):
        ...
        if (
            ...
            update_attributes = {
                ...
                "testCommandStatus": component_version_test_execution.ComponentVersionTestExecutionCommandStatus.Failed,
            }
