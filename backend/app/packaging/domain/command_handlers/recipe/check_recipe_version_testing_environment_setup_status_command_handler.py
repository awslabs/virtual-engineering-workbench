...
from app.packaging.domain.commands.recipe import check_recipe_version_testing_environment_setup_status_command
...
def handle(
    ...
    command_id = recipe_version_test_execution_entity.setupCommandId
    ...
    update_attributes = {"setupCommandStatus": command_status}
