...
class InitiateProvisionedProductsStopCommand(command_bus.Command):
    provisioned_product_ids: list[provisioned_product_id_value_object.ProvisionedProductIdValueObject] = pydantic.Field(
        ...
    )
