...
from app.provisioning.domain.command_handlers.provisioned_product_state import initiate_start
from app.provisioning.domain.commands.provisioned_product_state import initiate_provisioned_product_start_command
from app.provisioning.domain.events.provisioned_product_state import provisioned_product_start_initiated
...
def test_initiate_virtual_target_start_should_initiate_virtual_target_start(
    mock_logger,
    mock_publisher,
...
def test_initiate_virtual_target_start_with_wrong_project_id_should_raise(
    mock_logger,
    mock_publisher,
    mock_virtual_targets_qs,
    mock_message_bus,
...
def test_initiate_virtual_target_start_with_unauthorized_user_should_raise(
    mock_logger,
    mock_publisher,
    mock_virtual_targets_qs,
    mock_message_bus,
...
@freeze_time("2023-12-06")
def test_initiate_start_when_service_acct_should_not_check_for_user(
    mock_logger,
    mock_publisher,
    mock_virtual_targets_qs,
    mock_message_bus,
...
def test_initiate_start_when_service_acct_should_Validate_project_id(
    mock_logger,
    mock_publisher,
    mock_virtual_targets_qs,
    mock_message_bus,
