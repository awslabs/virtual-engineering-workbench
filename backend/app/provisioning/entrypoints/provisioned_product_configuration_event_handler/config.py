...
class AppConfig(BaseModel):
    ...
    def get_provisioned_product_configuration_document_mapping_param_name(self) -> str:
        return os.environ.get("PROVISIONED_PRODUCT_CONFIGURATION_DOCUMENT_MAPPING_PARAM_NAME", "")
