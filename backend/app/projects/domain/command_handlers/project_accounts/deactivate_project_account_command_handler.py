...
def handle_deactivate_project_account_command(
    cmd: deactivate_project_account_command.DeactivateProjectAccountCommand,
    ...
    with unit_of_work:
        for pa in project_accounts:
            if (
                pa.accountStatus == project_account.ProjectAccountStatusEnum.Active
                and cmd.account_status.value == project_account.ProjectAccountStatusEnum.Inactive
